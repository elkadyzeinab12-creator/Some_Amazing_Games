...
void selection(char &p, char &e, const std::string &player3, const std::string &player4);
...
bool win_lose_draw(const std::string &player3, const std::string &player4, char game_board[4][4], char p) ;
